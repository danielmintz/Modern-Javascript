...
const userThree = new Admin ('Dan', 'dan@aol.com')
...
userThree.deleteUser(userTwo); // only works when userThree ie has Admon class does this. 
console.log(users);
